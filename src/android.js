...
async function embed(args) {
    ...
    // NODE MODULE CHANGES
    // await readAndReplaceFileContent(`${embedAndroidProject}/../node_modules/@wavemaker/expo-native-module/android/build.gradle`, (content) => {
    //     return content.replace(`classifier`, `//classifier`);
    // })
